        ...
        <div class="row g-0">
            <div id="carouselExample" class="carousel slide carousel-fade position-relative" data-bs-ride="carousel" data-bs-interval="2900">
                ...
                <div class="carousel-inner">
                    <div class="carousel-conoceme position-relative">
                        <img src="assets/images/conoceme/portada.jpg" class="d-block w-100" alt="Imagen 2">
                ...
                <div class="container">
                    <div class="conoceme-text d-flex flex-column justify-content-center align-items-start text-start ps-5">
                        <h1 class="font-titulo fs-1 text-white" style="line-height: 1.2;">
                            Soy Eliane Hurtado y soy una<br>
